	...
	class MusicApp extends React.Component {
	    ...
	    checkedChanged(checked) {
	        this.setState({
	            ...
	            playerService_1.PlayerService.setIsMainPlayer(this.state.isMainPlayer);
	        });
	    }
	    addMusic() {
	        ...
	        playerService_1.PlayerService.studioAddMusic(url, () => {
	            urlInput.value = "";
	        });
	    }
	    render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	class Player extends React.Component {
	    ...
	    componentDidMount() {
	        ...
	        playerService_1.PlayerService.on("play.changed", music => {
	            self.setState({
	                name: music.name,
	                img: music.image
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	class MusicItem extends React.Component {
	    ...
	    render() {
	        ...
	        return React.createElement("li", { className: this.state.isPlay ? "list-group-item active" : "list-group-item" }, React.createElement("div", { className: "media" }, React.createElement("div", { className: "media-left" }, React.createElement("a", { href: "#", onClick: this.play.bind(this) }, React.createElement("img", { style: { width: '84px', height: '84px' }, class: "media-object", src: music.image, alt: music.name }))), React.createElement("div", { className: "media-body", style: { position: 'relative' } }, React.createElement("h4", { className: "media-heading" }, music.name), React.createElement("p", null, music.artists), React.createElement("div", { className: "btn-group", role: "group", "aria-label": "..." }, React.createElement("button", { type: "button", className: "btn btn-default btn-sm", onClick: this.play.bind(this) }, "播放"), React.createElement("button", { type: "button", className: "btn btn-default btn-sm", onClick: this.removeMusic.bind(this) }, "删除")), "-", music.orderer)));
	    }
	}
	...
	class PlayList extends React.Component {
	    constructor() {
	        super();
	        var self = this;
	        playerService_1.PlayerService.on("list.changed").then(musics => {
	            self.setState({
	                musics: musics
	            });
	        });
	    ...
	    render() {
	        return React.createElement("ul", { className: "list-group" }, this.state.musics.map(music => {
