	...
	var MusicApp = function (_super) {
	    ...
	    MusicApp.prototype.checkedChanged = function (checked) {
	        ...
	        this.setState({
	            ...
	            playerService_1.PlayerService.setIsMainPlayer(_this.state.isMainPlayer);
	        });
	    };
	    ...
	    MusicApp.prototype.render = function () {
	        return React.createElement("div", null, React.createElement("div", { className: "container", style: { marginBottom: '80px', marginTop: '20px' } }, React.createElement("div", { className: "panel panel-default" }, React.createElement("div", { className: "panel-heading" }, "Sparxo Player", React.createElement("label", { className: "pull-right" }, React.createElement("input", { type: "checkbox", checked: this.state.isMainPlayer, onChange: this.checkedChanged.bind(this), style: { verticalAlign: 'top' } }), "主播放器")), React.createElement("div", { className: "panel-body" }, React.createElement("div", { className: "input-group" }, React.createElement("input", { type: "text", ref: "txt_url", value: this.state.keyword, onChange: this.search.bind(this), className: "form-control", placeholder: "163音乐地址" }), React.createElement("span", { className: "input-group-btn" }, React.createElement("button", { className: "btn btn-default", onClick: this.addMusic.bind(this), disabled: this.state.keyword.indexOf("http://music.163.com") == -1, type: "button" }, "添加")))), React.createElement(list_1.PlayList, { filter: this.state.keyword }))), React.createElement(player_1.Player, { isMainPlayer: this.state.isMainPlayer }));
	    };
	    return MusicApp;
	}(React.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Music = Music;
	var PlayerServiceClass = function (_super) {
	    __extends(PlayerServiceClass, _super);
	    function PlayerServiceClass() {
	        _super.apply(this, arguments);
	        this.musics = [];
	        this.isMainPlayer = JSON.parse(localStorage['isMainPlayer'] || "false");
	    }
	    PlayerServiceClass.prototype.setIsMainPlayer = function (isMainPlayer) {
	    ...
	    PlayerServiceClass.prototype.setPlayer = function (player) {
	        var self = this;
	        self.player = player;
	    ...
	    PlayerServiceClass.prototype.playNext = function () {
	        var next;
	        if (!this.current) {
	            next = this.musics[0];
	        } else {
	    ...
	    PlayerServiceClass.prototype.getMusic = function (id) {
	    ...
	    PlayerServiceClass.prototype.studio = function () {
	        var self = this;
	        var d = q.defer();
	        //return new Promise((resolve, reject) => {
	        pomelo.init({
	    ...
	    PlayerServiceClass.prototype.studioEnter = function (userName) {
	        var self = this;
	    ...
	    PlayerServiceClass.prototype.studioAddMusic = function (url, callback) {
	        var self = this;
	    ...
	    PlayerServiceClass.prototype.studioRemoveMusic = function (id) {
	    ...
	    PlayerServiceClass.prototype.studioGetPlayerMusicList = function () {
	        ...
	        pomelo.request(route, {}, function (data) {
	            if (data.code !== 500) {
	                for (var _i = 0, _a = data.playerMusicList; _i < _a.length; _i++) {
	                    var item = _a[_i];
	    ...
	    PlayerServiceClass.prototype.studioUserIsExisted = function (userName) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlayList = function (_super) {
	    ...
	    function PlayList() {
	        _super.call(this);
	        var self = this;
	        playerService_1.PlayerService.on("list.changed").then(function (musics) {
	            self.setState({
	                musics: musics
	            });
	        });
	        this.state = {
	            musics: playerService_1.PlayerService.musics
	        };
	    }
