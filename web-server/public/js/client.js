...
$(document).ready(function() {
 ...
 //       console.log({ event: "onchat", data: data });
	//    return;
    ...
    pomelo.on('onBattle', function (data) {
        switch (data.action){
            case 1:
                ...
                interval = setInterval(function () { 
                    pomelo.request('arena.battleHandler.run', { battleId: "123456", step: 2 }, function () {
	...
	pomelo.on('disconnect', function (reason) {
	    console.log('connect is closed:' + reason.code);
		showLogin();
	});
